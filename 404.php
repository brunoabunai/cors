...
<head>
  <meta charset="UTF-8">
  <style>
    <?php include './src/styles/global.css'; ?><?php include './src/styles/classes.css'; ?><?php include './src/styles/boxes.css'; ?><?php include 'src/styles/404.css'; ?>
  </style>
</head>
...
<body>
  <div class="page-404">
    ...
    <span class="subtitle"><b>Page404</b> Ocorreu um erro inesperado</span>
    <a class="opacty-button btn-back404" href="./index.php?p=landing">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<script>
  ...
  //   }
  // })
  jQuery.post("./src/components/login.php", {myKey: 0}, function(data) { 
    console.log("Do something with example.php response");
    $('#a').html(data);
    console.log(data);
  }).fail(function() { 
