...
$valuesComparedDB = " SELECT * 
                      FROM users 
                      WHERE use_idPk = '".$_SESSION['registerUserId']."'
                    ";

$queries = $conn->query($valuesComparedDB) or die ($conn->error);
$data = $queries->fetch_assoc();

$nameAdmin = (count($data) != 0) ? $data['use_name'] : 'Nenhum!';
?>
...
<body>
    ...
    ?>
        <div class="portable-page">
            <div class="landing">
                <h2 class="title">
                    <?php echo $nameAdmin ?> Registrado Com Sucesso!
                </h2>
            </div>

            <div class="main">

                <a href="./index.php?p=menu" class="btn opacty-button">
                ...
                <a href="./index.php?p=edit" class="btn opacty-button">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    Editar <?php echo "{$nameAdmin}" ?>
                </a>

                <a href="./index.php?p=register" class="btn opacty-button">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
